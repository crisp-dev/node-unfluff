...
void function () {
  var _, cleanArticleTags, cleanBadTags, cleanCodeBlocks, cleanEmTags, cleaner, cleanErrantLinebreaks, cleanParaSpans, cleanUnderlines, divToPara, getReplacementNodes, recurseReplaceLimit, removeBodyClasses, removeDropCaps, removeNodesRegex, removeScriptsStyles, replaceWithPara;
  _ = require('lodash');
  ...
  cleanEmTags = function (doc) {
    var ems;
    ems = doc('em');
    return ems.each(function (index) {
      var images;
      images = ems.find('img');
  ...
  cleanCodeBlocks = function (doc) {
    ...
    return nodes.each(function (index) {
  ...
  divToPara = function (doc, domType) {
    ...
    return divs.each(function (index) {
  ...
  cleanErrantLinebreaks = function (doc) {
    return doc('p').each(function (index) {
      var c, node;
      if (index < recurseReplaceLimit) {
        node = doc(this);
        c = node.contents();
        return doc(c).each(function (subindex) {
          var n;
